...
This is the project from "DataCamp Data Science Project" which is trying to analyze the Apps dataset based on more then ten thousand apps across categories. Analyzing and give insights of paid apps vs free apps, their ratings, market shares, and doing some sentiment analysis as well
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      <th>3077</th>
      <td>3857</td>
      <td>Radarbot Free: Speed Camera Detector &amp; Speedom...</td>
...
<iframe width="900" height="800" frameborder="0" scrolling="no" src="//plotly.com/~fsyarafa19/1.embed"></iframe>
